...
Generated @ Tue Jan  8 06:58:12 2019
'''
import sqlite3
...
class Employee:
    ...
    @staticmethod
    def Import(dao, text_file='Employee.csv', hasHeader=True, sep='","'):
        try:
            # dao.open()
...
class Principal:
    ...
    @staticmethod
    def Import(dao, text_file='Principal.csv', hasHeader=True, sep='","'):
        try:
            # dao.open()
            with open(text_file) as fh:
                line = fh.readline().strip()
...
class Event:
    ...
    @staticmethod
    def Import(dao, text_file='Event.csv', hasHeader=True, sep='","'):
        try:
            # dao.open()
            with open(text_file) as fh:
                line = fh.readline().strip()
...
class ToDo:
    ...
    @staticmethod
    def Import(dao, text_file='ToDo.csv', hasHeader=True, sep='","'):
        try:
            # dao.open()
            with open(text_file) as fh:
                line = fh.readline().strip()
...
class Entry:
    ...
    @staticmethod
    def Import(dao, text_file='Entry.csv', hasHeader=True, sep='","'):
        try:
            # dao.open()
            with open(text_file) as fh:
                line = fh.readline().strip()
